...
(function () {
  ...
  */
  ...
  function useTransition(_ref) {
    ...
    var getDurationOverride = useStableGetter(d);
    ...
    var onStateChange = T$1((nextState, prevState, reason) => {
      ...
      var durationOverride = getDurationOverride();
      if (durationOverride != null) {
        cssProperties.current["--".concat(classBase, "-duration")] = durationOverride + "ms";
        element === null || element === void 0 ? void 0 : element.style.setProperty("--".concat(classBase, "-duration"), "".concat(durationOverride, "ms"));
      }
