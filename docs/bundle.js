(function () {
  ...
  const getBuildMode = memoize$1(getBuildModeUnmemoized);
  ...
  let globalCount = -1;
  function ExclusiveTransitionProvider(_ref) {
    let {
      exclusivityKey,
      children
    } = _ref;
  ...
  function useExclusiveTransition(_ref2) {
    let {
   ...
   * @returns
   */
  const Swappable = x(forwardElementRef(function Swappable(_ref2, ref) {
    var _inline;
    let {
      children: c,
      inline,
   ...
   * Be sure to merge these returned props with whatever the user passed in.
   */
  function useBasePropsFade(_ref) {
    let {
      fadeParameters: {
        fadeMin,
        fadeMax
   ...
   * @see `Transitionable`
   */
  const Fade = x(forwardElementRef(function Fade(_ref2, ref) {
    let {
      duration,
      exclusivityKey,
      easing,
  ...
  function useBasePropsClip(_ref) {
    ...
    return {
      ...
      style: {
        ["--".concat(GetBaseClass(), "-clip-origin-inline")]: (_ref2 = clipOriginInline !== null && clipOriginInline !== void 0 ? clipOriginInline : clipOrigin) !== null && _ref2 !== void 0 ? _ref2 : 0.5,
        ["--".concat(GetBaseClass(), "-clip-origin-block")]: (_ref3 = clipOriginBlock !== null && clipOriginBlock !== void 0 ? clipOriginBlock : clipOrigin) !== null && _ref3 !== void 0 ? _ref3 : 0,
        ["--".concat(GetBaseClass(), "-clip-min-inline")]: (_ref4 = clipMinInline !== null && clipMinInline !== void 0 ? clipMinInline : clipMin) !== null && _ref4 !== void 0 ? _ref4 : 1,
        ["--".concat(GetBaseClass(), "-clip-min-block")]: (_ref5 = clipMinBlock !== null && clipMinBlock !== void 0 ? clipMinBlock : clipMin) !== null && _ref5 !== void 0 ? _ref5 : 0
      }
    };
  }
   ...
   */
  function useBasePropsCollapse(_ref) {
    let {
      collapseParameters: {
        minBlockSize
      }
   ...
   */
  function useBasePropsFlip(_ref) {
   ...
   */
  function useBasePropsSlide(_ref) {
   ...
   * Creates a set of props that implement a Zoom transition. Like all `useCreate*Props` hooks, must be used in tamdem with a `Transitionable` component (or `useCreateTransitionableProps`).
   */
  function useBasePropsZoom(_ref) {
    var _ref2, _ref3, _ref4, _ref5;
    let {
      zoomParameters: {
        zoomOrigin,
    ...
    return {
      ...
      style: {
        ["--".concat(GetBaseClass(), "-zoom-origin-inline")]: "".concat((_ref2 = zoomOriginInline !== null && zoomOriginInline !== void 0 ? zoomOriginInline : zoomOrigin) !== null && _ref2 !== void 0 ? _ref2 : 0.5),
        ["--".concat(GetBaseClass(), "-zoom-origin-block")]: "".concat((_ref3 = zoomOriginBlock !== null && zoomOriginBlock !== void 0 ? zoomOriginBlock : zoomOrigin) !== null && _ref3 !== void 0 ? _ref3 : 0.5),
        ["--".concat(GetBaseClass(), "-zoom-min-inline")]: "".concat((_ref4 = zoomMinInline !== null && zoomMinInline !== void 0 ? zoomMinInline : zoomMin) !== null && _ref4 !== void 0 ? _ref4 : 0),
        ["--".concat(GetBaseClass(), "-zoom-min-block")]: "".concat((_ref5 = zoomMinBlock !== null && zoomMinBlock !== void 0 ? zoomMinBlock : zoomMin) !== null && _ref5 !== void 0 ? _ref5 : 0)
      }
    };
  }
  /**
