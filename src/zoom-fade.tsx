...
export const ZoomFade = forwardElementRef(function ZoomFade<E extends HTMLElement>({ classBase, duration, fadeMin, fadeMax, show, animateOnMount, zoomMin, zoomMinBlock, zoomMinInline, zoomOrigin, zoomOriginBlock, zoomOriginInline, exitVisibility, ...rest }: ZoomFadeProps<E>, ref: Ref<E>) {
    return (
        <Transitionable<E>
