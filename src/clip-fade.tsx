...
export const ClipFade = forwardElementRef(function ClipFade<E extends HTMLElement>({ classBase, duration, fadeMin, fadeMax, show, animateOnMount, clipMin, clipMinBlock, clipMinInline, clipOrigin, clipOriginBlock, clipOriginInline, exitVisibility, ...rest }: ClipFadeProps<E>, ref: Ref<E>) {
    return (
        <Transitionable<E>
