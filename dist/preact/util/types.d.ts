...
export interface UseTransitionParameters<E extends Element> extends UseRefElementParameters<E>, TargetedOmit<UseExclusiveTransitionParameters, "exclusiveTransitionParameters", "forceClose"> {
 ...
 */
export interface TransitionParametersBase<E extends Element> extends OmitStrong<Get<UseTransitionParameters<E>, "transitionParameters">, "measure" | "propsIncoming">, Get<UseTransitionParameters<E>, "exclusiveTransitionParameters">, Partial<Get<UseRefElementParameters<E>, "refElementParameters">>, NonIntrusiveElementAttributes<E> {
}
