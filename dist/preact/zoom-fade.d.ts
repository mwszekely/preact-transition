...
export interface ZoomFadeProps<E extends Element> extends TransitionParametersBase<E>, Partial<Get<UseBasePropsFadeParameters, "fadeParameters">>, Partial<Get<UseBasePropsZoomParameters, "zoomParameters">>, Partial<Get<UseRefElementParameters<E>, "refElementParameters">> {
}
