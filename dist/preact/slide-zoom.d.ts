...
export interface SlideZoomProps<E extends Element> extends TransitionParametersBase<E>, Partial<Get<UseBasePropsZoomParameters, "zoomParameters">>, Partial<Get<UseBasePropsSlideParameters, "slideParameters">>, Partial<Get<UseRefElementParameters<E>, "refElementParameters">> {
}
