...
export interface CollapseFadeProps<E extends Element> extends TransitionParametersBase<E>, Partial<Get<UseBasePropsFadeParameters, "fadeParameters">>, Partial<Get<UseBasePropsCollapseParameters, "collapseParameters">>, Partial<Get<UseRefElementParameters<E>, "refElementParameters">> {
}
