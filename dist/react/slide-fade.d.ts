...
export interface SlideFadeProps<E extends Element> extends TransitionParametersBase<E>, Partial<Get<UseBasePropsFadeParameters, "fadeParameters">>, Partial<Get<UseBasePropsSlideParameters, "slideParameters">>, Partial<Get<UseRefElementParameters<E>, "refElementParameters">> {
}
