...
export interface SlideZoomFadeProps<E extends Element> extends TransitionParametersBase<E>, Partial<Get<UseBasePropsZoomParameters, "zoomParameters">>, Partial<Get<UseBasePropsSlideParameters, "slideParameters">>, Partial<Get<UseBasePropsFadeParameters, "fadeParameters">>, Partial<Get<UseRefElementParameters<E>, "refElementParameters">> {
}
